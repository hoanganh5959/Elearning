...
// Tắt cảnh báo Deprecated khi sử dụng Google API Client
...
class Google_Model implements ArrayAccess
{
  ...
  /**
   * Implements the actual methods/properties
   *
   * Note:
   * All properties of the object should be defined in the __construct() method.
   *
   * @property string $id
